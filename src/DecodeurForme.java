...
public class DecodeurForme {
	...
	public DecodeurForme(String chaineForme)
	{
		...
		if (!matcher.find())
		{
			throw new IllegalArgumentException("La chaine de la forme n'a pas pu être interprétée.");
		}
	...
	/**
	 * 
	 * @return un tableau contenant les paramètres additionnels de la forme
	 */
